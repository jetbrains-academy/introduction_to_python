...
class TestCase(unittest.TestCase):
    ...
    def test_greater(self):
        ...
        self.assertEqual(expected_is_greater, actual_is_greater, msg="The is_greater has a wrong value. "
                                                                     "Make sure you use a correct operator.")
    ...
    def test_less(self):
        ...
        self.assertEqual(expected_is_less, actual_is_less, msg="The is_less has a wrong value. "
                                                               "Make sure you use a correct operator.")
    ...
    def test_chained_arbitrary(self):
        ...
        self.assertEqual(expected_is_true, actual_is_true, msg="The is_true has a wrong value. "
    ...
    def test_not_equal(self):
        ...
        self.assertEqual(expected_not_equal, actual_not_equal, msg="The not_equal has a wrong value. "
                                                                   "Make sure you use a correct operator.")
    ...
    def test_equal(self):
        ...
        self.assertEqual(expected_is_equal, actual_is_equal, msg="The is_equal has a wrong value. "
                                                                 "Make sure you use a correct operator.")
