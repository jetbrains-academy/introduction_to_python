...
class TestCase(unittest.TestCase):
    ...
    def test_object_type(self):
        ...
        # can not render <class smth> correctly and for me the result is less intriguing this way
        self.assertTrue(expected_output in actual_output, msg="The statement about type of the float_number is missing "
                                                              "from the output, or its type has changed.")
