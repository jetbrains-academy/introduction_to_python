...
class TestCase(unittest.TestCase):
    def test_out_len(self):
        self.assertEqual(len(output), 3, msg='Do not remove or add any print statements.')
    ...
    def test_string_age(self):
        self.assertIsNotNone(re.search('\d+', result_str), msg='The result string does not contain your age.')
