...
class TestCase(unittest.TestCase):
    ...
    @wrapt_timeout_decorator.timeout(2, timeout_exception=TimeoutError)
    def test_keyword_return(self):
        try:
            ...
            try:
                ...
                self.fail(msg="There was a problem while loading the fib function. Make sure its declaration stays intact.")
