...
try:
    ...
    class TestCase(unittest.TestCase):
        ...
        def test_condition1(self):
            self.assertNotEqual('False', output[1], msg='You need to print True if the name is "John"')

        def test_condition(self):
            self.assertEqual('True', output[1], msg='You need to print True if the name is "John"')
